    ...
    <script>
        (function() {{
            ...
            try {{
                ...
                console.log("✅ Loaded " + window.streamlitCo           console.error("❌ Failed to parse comments JSON:", e);
...
def render_document_editor():
    ...
    # ========================================================================
        ...
        # Detect mobile for stacking
        is_mobile = st.session_state.get('is_mobile', False)
        
        if is_mobile:
            col_versions = st.container() if "versions" in panels_open else None
            col_editor = st.container()
            col_chat = st.container() if "chat" in panels_open else None
        elif len(panels_open) == 2:  # Both panels
