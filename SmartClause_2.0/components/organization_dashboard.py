...
def render_subscription_overview(subscription: Dict, org: Dict):
    ...
    st.markdown('''
        <div class="org-card">
            <div class="org-card-title" style="display:flex;align-items:center;">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin-right:8px;color:#4B9EFF;">
