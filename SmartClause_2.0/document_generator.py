...
Generate the document now."""
    ...
    def generate_document_stream(self, payload: Dict[str, Any]) -> Generator[str, None, None]:
        ...
        try:
            ...
            import logging
            logging.getLogger(__name__).error(f"Document generation error: {e}", exc_info=True)
            yield "\n\n[Document generation encountered an issue. Please try again.]"
